...
color_palete = {
    ...
    "Sparse LU": "#8a3ffc",
    "Thomas Algorithm": "#a56eff",
    "Thomas Algorithm No -O3": "#3ddbd9",
    "Thomas Algorithm -O3": "#a56eff",
}
...
big_files = [
    ...
    "./bench_data/optimised_sparse_qr_100k.csv",
    "./bench_data/optimised_thomas_100k.csv",
]
gen_combined(big_files, "figures/big_mat_100k.jpg", [0, 0, 0])

big_files = [
    "./bench_data/optimisation_cmp/o3_thomas_100k.csv",
    "./bench_data/optimisation_cmp/no_o3_thomas_100k.csv",
]
gen_combined(big_files, "figures/O3_comparison_100k.jpg", [0, 0])
