...
all_y_offsets = [70000000, -70000000, 0, -8000000, -4000000, 0, 0]
all_files = [
    ...
    "./bench_data/methods_10k/optimised_thomas.csv",
]
gen_combined(all_files, "figures/all_combined_10k.jpg", all_y_offsets)
...
gen_combined(
    dense_files, "figures/dense_combined_10k.jpg", dense_y_offsets, x_start=1500
)
...
gen_combined(
    sparse_files, "figures/sparse_combined_10k.jpg", sparse_y_offsets, x_start=1500
)
